...
#   ... HEAP_RESERVE 4M STACK_RESERVE 32K).
set(CRONOPIO_DEFAULT_HEAP_RESERVE  "1M" CACHE STRING "Default cart heap reserve")
set(CRONOPIO_DEFAULT_STACK_RESERVE "64K" CACHE STRING "Default cart stack reserve")

function(cronopio_add_cartridge name)
    cmake_parse_arguments(ARG "" "HEAP_RESERVE;STACK_RESERVE" "SOURCES" ${ARGN})
    if(NOT ARG_SOURCES)
